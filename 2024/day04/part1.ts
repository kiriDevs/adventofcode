...
const HINT_SYMBOL = SEARCH_STRING.split("")[0];
...
const totalHitCount = hints.map(investigateHint).reduce((acc, hitCount) => acc + hitCount);
console.log("Part 1:", totalHitCount);
